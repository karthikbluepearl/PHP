...
.search:hover{
  transform: scale(1.1);
  box-shadow: 0px 12px 12px -3px rgba(0, 0, 0, 1.0);
...
<body>
    ...
    <h2>View Student Courses Records</h2>
...
<script type="text/javascript">
  ...
  <form action="COURSECODE_UPDATION_TABLE_UPADATE.php" method="post" name="frm1" id="form1">
 ...
 <!-- <button class="btn1 btn-primary btn-lg" action="Sem_tb_table.php" onclick="ExportToExcel('xlsx')">excel</button>
  -->
  <div class="card">
  <h4><b>Update Your Courses Records</b></h4>
...
<th><strong>Cource Name</strong></th>
<th><strong>Course Year</strong></th>

<th><strong>Internal Min Mark</strong></th>
<th><strong>Internal Max Mark</strong></th>
<th><strong>External Min Mark</strong></th>
<th><strong>External Max Mark</strong></th>
</tr>
</thead>
